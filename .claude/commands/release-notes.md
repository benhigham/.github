...
Write user-facing release notes — translate commit messages into plain language.
Skip internal refactors unless they affect behaviour.

If this is running in CI on a release event, update the release body using
`gh release edit`. If running locally, output the notes to stdout.
