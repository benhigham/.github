...
Steps:
1. Identify changed source files that have corresponding documentation (README, JSDoc, inline docs, content/ files)
...
Commit documentation updates on the PR branch with message: `docs: update documentation for [changed area]`
